...
import { ref } from "vue";
import { CalendarClock, ToolCase } from "lucide-vue-next";
import ParticleCursorFollow from "./shared/ParticleCursorFollow.vue";
...
<template>
  <ParticleCursorFollow class="flex justify-center min-h-[90vh] bg-black">
    <section
      class="flex flex-col w-full justify-center items-center py-20 px-4 text-white"
    >
      <div class="mb-12">
        <img
          src="../assets/simetrik-white.png"
          alt="Simetri-K"
          class="w-[12em] md:w-[15em] transition-all duration-[2000ms] transform"
          :class="
            showContent
      ...
      >
        <Typewriter
          ...
          :typing-speed="60"
          :blink-speed="'0.8s'"
          @on-finished="showContent = true"
        />
      </div>
      <div
        class="max-w-2xl text-center transition-all duration-[2000ms] transform"
        :class="
      ...
      <div
        class="flex flex-wrap justify-center gap-5 mt-16 transition-all duration-[2000ms] delay-300 transform"
        :class="
          showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
        "
      >
